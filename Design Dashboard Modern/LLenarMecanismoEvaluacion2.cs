...
{
    public partial class LLenarMecanismoEvaluacion2 : Form
    {
        public LLenarMecanismoEvaluacion2()
        {
            InitializeComponent();
        }
        ...
        private void BtVolverLLenado_Click(object sender, EventArgs e)
        {
            ...
            abrir.TxtMecanismoEvaluacion.Text = TxtMecanismoEvaluacionFrom.Text;
            this.Hide();
        }
